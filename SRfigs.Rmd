...
ggsave(
  './figures/defense/stageGlobal.png',
       dpi=800,
       width=12,
       height=8)
...
ggsave(
  './figures/SR_response/global.png',
       dpi=800,
       width=12,
       height=8)
...
ggsave(
  './figures/SR_response/ndvi_overtime.png',
       dpi=800,
       width=12,
       height=8)
...
ggsave('./figures/SR_response/NDVIbayesSimple.png',
       dpi=800,
       height=8,
       width=12)
...
ggsave(
  './figures/SR_response/NDVI_bayes.png',
       dpi=800,
       width=12,
       height=8)
...
ggsave(
  './figures/SR_response/PCA_catchmentvars.png',
       dpi=800,
       width=12,
       height=8)
...
ggsave(
  './SR_response/interactionbayesSimple.png',
       dpi=800,
       width=12,
       height=8)
...
ggsave(
  './figures/SR_response/interaction_bayes.png',
       dpi=800,
       width=12,
       height=8)
...
ggsave(
  './figures/SR_response/pwdSimple.png',
       dpi=800,
  width=12,
  height=8)
...
ggsave('./SR_response/PWDbayesSimple.png',
       dpi=800,
       height=8,
       width=12)
...
ggsave(
  './figures/SR_response/PWD_bayes.png',
       dpi=800,
       width=12,
       height=8)
